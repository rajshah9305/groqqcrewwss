...
try:
    ...
    logging.error(f"CrewAI not installed: {str(e)}. Please run: pip install -r requirements.txt")
    sys.exit(1)
...
def execute_nlp_task(task_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        logging.error(f"Error executing NLP task: {str(e)}")
        return {
            "success": False,
            "error": str(e),
...
def execute_multi_agent_task(task_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        logging.error(f"Error executing multi-agent task: {str(e)}")
        return {
            "success": False,
            "error": str(e),
            "task_type": "multi_agent"
